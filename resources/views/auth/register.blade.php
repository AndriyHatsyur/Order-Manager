                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label  class="col-md-4 col-form-label text-md-right">Табельний</label>

                            <div class="col-md-6">
                                <input type="text" class="form-control{{ $errors->has('t_number') ? ' is-invalid' : '' }}" name="t_number" value="{{ old('t_number') }}" required>
